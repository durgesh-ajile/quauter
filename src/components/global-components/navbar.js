...
import i18nlan from "../../i18nlan";
// import en from "../../translation/en/en.json";
// import hn from "../../translation/hn/hn.json";
...
const Navbar = () => {
  ...
  const changeLanguage = (lng) => {
    ...
    lng == "en" ? setLanguage("Hindi") || sethindi(false)  : setLanguage("English") || sethindi(true);
  };
  const handleLanguage = () => {
    hindi == false ? changeLanguage("hn") : changeLanguage("en");
  };
                  ...
                  <ul>
                    <li>
                      <a href="mailto:info@webmail.com?Subject=Flower%20greetings%20to%20you">
                        <i className="icon-mail" /> contact@deraa.in
                      </a>
                    </li>
                    <li>
                ...
                <div className="top-bar-right text-end">
                  <div className="ltn__top-bar-menu">
                    ...
                    >
                      ...
                      <li>
                        <div className="header-top-btn language" >
                          <button
            ...
            <div className="row">
                  ...
                  <nav>
                    <div className="ltn__main-menu go-top">
                      <ul>
                        ...
                        <li className="">
                          <Link to="/blog-grid">{t("Blogs")}</Link>
                        </li>
              ...
              <div className="col ltn__header-options ltn__header-options-2 mb-sm-20">
                ...
                <div>
                  ...
                  {/* <button onClick={() =>handleLanguage()}>hn</button> */}
                </div>
                {/* mini-cart */}
            ...
            <ul>
              ...
              <li>
                ...
                {/* <ul className="sub-menu">
                    ...
                    <li>
                      <Link to="/add-listing">List Yourself to get Work</Link>
                    </li>
                    <li>
